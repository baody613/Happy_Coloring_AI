...
> _Chữ nghiêng_ là chỉ dẫn hành động — không đọc to.  
...
_Bước lên, chào hội đồng, đứng thẳng tự nhiên._
...
## [SLIDE 2] — CÔNG NGHỆ — FRONTEND _(PHẦN 1 / ~2 phút)_
...
>
> Về **AI APIs**, em sử dụng **Gemini 2.5 Flash Image** để tạo tranh tô màu từ văn bản. **MyMemory API** dịch prompt từ tiếng Việt sang tiếng Anh trước khi gửi cho Gemini.
>
...
## [SLIDE 5] — 7 NHÓM TÍNH NĂNG CHÍNH _(PHẦN 2 / ~4 phút)_
...
>
> **Nhóm 3 — Giỏ hàng:** Giỏ hàng dùng Zustand persist — state không mất khi reload trang. Người dùng có thể lưu sản phẩm vào danh sách 'yêu thích' để mua sau. Hệ thống hỗ trợ 5 mã giảm giá: `YULING10` giảm 10%, `YULING20` giảm 20%, `YULING30` giảm 30%, `GIAMGIA15` giảm 15%, và `KHAITRUONG` giảm 25%.
>
> **Nhóm 4 — Thanh toán:** Hỗ trợ COD (Tiền mặt khi nhận hàng) và Chuyển khoản ngân hàng. Thông tin tài khoản ngân hàng (tên ngân hàng, số tài khoản, mã QR) được tải động từ cấu hình môi trường backend.
>
...
## [SLIDE 7] — TẠO ẢNH AI — TỔNG QUAN _(PHẦN 3 / ~5 phút — TÍNH NĂNG CỐT LÕI)_
...
>
> **Bước 3 — Prompt Engineering:** Hàm `buildLineArtPrompt()` chạy ở nền dưới dạng **fire-and-forget** — không có `await`, không block Event Loop của Node.js. Prompt được lắp ghép từ template: mô hình được gán vai trò _'một illustrator paint-by-numbers chuyên nghiệp'_, tiếp theo là các **ràng buộc cứng** như vùng kín, đánh số, màu theo bảng màu, không watermark, không nội dung không phù hợp.
>
...
>
> _Nói phần kết luận thật bình tĩnh và tự tin:_
>
...
_Kết thúc file — Tống Bảo Duy, GCS210642, Đại học Greenwich Việt Nam, 2025–2026_
