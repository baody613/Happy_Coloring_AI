...
import { collection, query, onSnapshot, where, Query, QueryConstraint } from 'firebase/firestore';
...
export default function AdminOrdersClient() {
  ...
  // Setup auth check and initial loading
  useEffect(() => {
    ...
    // update filter from URL when available
    try {
  ...
  // Load orders when filterStatus changes
  useEffect(() => {
  ...
  const handleStatusChange = async (orderId: string, newStatus: string) => {
    try {
      ...
      // Firestore listener sẽ tự động cập nhật
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          >
            {/* Use a single span for all content */}
