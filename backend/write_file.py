...
with open('N:/Project-Final-year/paint-by-numbers-ai/backend/src/routes/password-reset.js', 'w', encoding='utf-8') as f:
    f.write(content)

print("File written successfully with UTF-8 encoding (no BOM)")
